<h2><a href="https://practice.geeksforgeeks.org/problems/gcd-of-two-numbers3459/1">GCD of two numbers</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two positive integers A and B, find GCD of A and B.</span></p>
